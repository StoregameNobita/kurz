...
GITHUB OWNER:https://github.com/StoregameNobita
YOUTUBE OWNER:https://youtube.com/c/FFNOBITA`
...
break
		...
		anu =`SILAHKAN PILIH⬇`
 buttons = [
{buttonId: `dmff`, buttonText: {displayText: 'DIAMOND FF💎'}, type: 1},
{buttonId:`dmml`,buttonText:{displayText:'DM MOBILE LEGEND💎'},type:1},
{buttonId: `ucpubg`, buttonText: {displayText: 'UCPUBG📮'}, type: 1}
{buttonId: `cpcodm`, buttonText: {displayText: 'CPCODM💳'}, type: 1}
]
const btnskuy = {
    contentText: `${anu}`,
    footerText: '*_FF NOBITA_*',
    buttons: buttons,
    headerType: 1
}
...
*1.440💎 : 181.000*
*2.000💎 : 247.100*
*membership mingguan💳 : 27.550*
*membership bulanan💳     : 137.000*
└❏`
 buttons = [
...
const btnskuy = {
    contentText: `${anu}`,
    footerText: 'minat? https://wa.me/6285749037935',
    buttons: buttons,
    headerType: 1
}
await kurr.sendMessage(from, btnskuy, MessageType.buttonsMessage, {quoted: ftrol})
...
Twilight Pass💎 : 94.000
Starlight Pass💎 : 220.000
└❏`
 buttons = [
{buttonId: `menu`, buttonText: {displayText: 'BACK➡️'}, type: 1},
{buttonId:`donasi`,buttonText:{displayText:'DONASI'},type:1},
...
const btnskuy = {
    contentText: `${anu}`,
    footerText: 'sory bro belum buat list',
    buttons: buttons,
    headerType: 1
}
await kurr.sendMessage(from, btnskuy, MessageType.buttonsMessage, {quoted: ftrol})
