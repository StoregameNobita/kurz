...
const ownerNumber = "6285749037935@s.whatsapp.net"
const dtod = "6285749037935@s.whatsapp.net"
const otod = "6285749037935@s.whatsapp.net"
// STICKER WM
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Nobita-Botz🤖_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `Nobita-Botz🤖`, "footerText": "*_© Nobita-Botz🤖_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Nobita-Botz🤖_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
if(budy.includes('mir')){
cpref = `Hayo Ngomongin OwnerYaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('amir')){
cpref = `Hayo Ngomongin Owner Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© FF NOBITA007_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/storegame.nobita')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/FFNOBITA007')
}
 ...
 _Nama Bot : Nobita-Botz🤖_
 _Nama Owner : ${NamaOwner}_
 _Nomor Owner : FF NOBITA
...
${nomor++}.  ${prefix}asupan
${nomor++}.  ${prefix}asupancecan
${nomor++}.  ${prefix}asupanhillllljaber
${nomor++}.  ${prefix}asupansantuy
${nomor++}.  ${prefix}asupanukhti
${nomor++}.  ${prefix}asupanbocil
${nomor++}.  ${prefix}asupanhea
${nomor++}.  ${prefix}asupanrika
│
─❒ EVAL
${nomor++}.  *x*
${nomor++}.  *>*
...
│
─❒ NEWMENU
${nomor++}.  ${prefix}ppcouple


└─────────────────❒`
sendButLocation(from, `${menu}`, "*_©Nobita-Botz🤖_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'ＳＥＷＡ　ＢＯＴ'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
GITHUB OWNER:https://github.com/StoregameNobira
YOUTUBE OWNER:https://youtube.com/c/FFNOBITA007`
sendButLocation(from, `${menu}`, "*_© Nobita-Botz🤖_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
case 'catalog': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                nama = ' Nobita-Botz🤖 '
       ownerJid = "6285749037935@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menunya = `╭─❒ 「 Bot Info 」 ❒
 _Creator : *FF NOBITA007*
 _Battery : ${baterai.battery}_
 _Mode : ${publik ? 'Public' : 'Self'}_
 _Total Hit : ${cmhit.length}_
 _Total menu : 385_
...
*membership bulanan💳     : 133.000*
└❏`
sendButLocation(from, `${menu}`, "*_© Nobita-Botz🤖_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
       ...
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
fs.readFileSync ('./media/store.mp3')
...
simple.updatePresence(from, Presence.recording)
			...
			simple.sendMessage(from, cowo, image, {caption: 'Ini Untuk »  *Cowokny🙎‍♂️*'})
       cewe = await getBuffer(anu.result.cewe_image)
		    pll = `Ini Untuk » *CEWEKNY👳‍♀️*`
   sendButImage(from, pll, `NOBITA-BOTZ © 2021`, cewe, [                      
          {
...
kurr.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Kak'})
break
case 'asupancecan':
simple.updatePresence(from, Presence.recording)
...
kurr.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Kak'})
break
case 'asupanhijaber':
simple.updatePresence(from, Presence.recording)
...
ini_list.push({
"displayName": `Developer Nobita-Botz🤖`,
...
break
		...
		10K:6BULAN
		20K:MANEN
		SC? https://github.com/StoregameNobita`
 buttons = [
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Nobita-Botz🤖`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Nobita-Botz🤖`,
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subscribe FF NOBITA007"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
case 'matrix':
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                break
					case 'restart':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
reply(`_Restarting Nobita-Botz🤖_`)
exec(`cd &&  node index`)
sleep(4000)
reply('Sukses')
break
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Nobita-Botz🤖`}, MessageType.location)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY Nobita-Botz🤖`)
...
for (let i = 0; i < args[0]; i++) {
kurr.sendMessage(from, `Nobita-Botz🤖`, MessageType.extendedText,{
 quoted: {
key: {
...
kurr.sendMessage(from, `Nobita-Botz🤖`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Nobita-Botz🤖",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6281220670449"}}})
	}
    }
    }
    }
